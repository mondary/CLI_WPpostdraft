            ...
            <value>
                <struct>
                    ...
                    <member>
                        ...
                        <value>
                            <array>
                                <data>"; fi)$([ -n "$featured_image_url" ] && echo "
                                    <value>
                                        <struct>
                                            <member>
                                                <name>key</name>
...
main() {
    ...
    local payload=$(create_post_payload "$POST_TITLE" "$POST_CONTENT" "$POST_SLUG" "$WP_USERNAME" "$WP_PASSWORD" "$FEATURED_IMAGE_ID" "$IMAGE_URL" "$POST_EXCERPT")
